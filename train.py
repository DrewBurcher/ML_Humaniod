...
"""
# Claude assisted with parts of this file.
...
import env as _  # noqa â€“ triggers gym.register
...
# â”€â”€ Environment factory â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Video eval callback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class VideoEvalCallback(EvalCallback):
    ...
    def _init_video_env(self):
        ...
        import env as _env_reg  # noqa â€” ensures T1Walking-v0 is registered
...
# â”€â”€ Curriculum callback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

class CurriculumCallback(BaseCallback):
    """Unlocks arm joints at a given timestep (phase 1 â†’ phase 2 transition).
    ...
    def _on_step(self) -> bool:
        if not self.switched and self.num_timesteps >= self.switch_at:
            try:
                ...
                self.switched = True
                print(f"\n[Curriculum] Phase 2 â€” arms unlocked at "
...
# â”€â”€ Camera follow callback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Metrics logging callback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Periodic save callback (for resume support) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Main train function â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def train(algo_name, total_timesteps, run_name, reward_weights=None,
    ...
    # â”€â”€ Auto-commit to git â”€â”€
    _auto_commit()

    # â”€â”€ Determine if resuming â”€â”€
    ...
    if can_resume:
        ...
        for mf in monitor_files:
            ...
            try:
                ...
                os.remove(mf)
                print(f"[Resume] Archived monitor CSV â†’ {archive_name}")
            except Exception:
                pass
            next_session += 1

    # Write a render flag file â€” dashboard can toggle this
    render_flag_path = os.path.join(log_dir, ".render_on")
    with open(render_flag_path, "w") as f:
        f.write("1")

    # Pause flag file â€” dashboard can toggle this
    pause_flag_path = os.path.join(log_dir, ".paused")
    with open(pause_flag_path, "w") as f:
        f.write("0")

    # â”€â”€ Create environments â”€â”€
    ...
    if can_resume:
        ...
        if hasattr(model, "replay_buffer") and os.path.exists(replay_buf_path):
            ...
            print("[Resume] WARNING: No replay buffer found â€” critic may be unstable initially")
    else:
        if algo_name == "ppo":
            cfg = PPO_CONFIG.copy()
    ...
    # Preserve eval history across resumes â€” SB3 otherwise overwrites the npz.
    if can_resume:
    ...
    # â”€â”€ Random baseline eval (only for fresh runs) â”€â”€
    if not can_resume:
    ...
    # â”€â”€ Launch dashboard in separate process â”€â”€
    plot_proc = None
    if live_plot:
