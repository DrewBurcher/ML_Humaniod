...
# Claude was used to generate the entire implementation of this file
# based on the project design and structure created by hand.
# The code logic, functions, and structure were all generated by AI.
